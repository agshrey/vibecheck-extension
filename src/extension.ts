...
export async function activate(context: vscode.ExtensionContext) {
	...
	context.subscriptions.push(
		...
		vscode.commands.registerCommand('toolbox.inlinePasteDetection', () => inlinePasteDetection(context)),
		vscode.commands.registerCommand('toolbox.spectatorMode', () => spectatorMode(context)),
		vscode.commands.registerCommand('toolbox.tabDetection', () => registerTabDetection(context))
	);
